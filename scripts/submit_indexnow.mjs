...
const priorityPaths = [
  ...
  '/greece/crete/breweries/',
  '/greece/crete/dairies-cheesemakers/',
  '/greece/crete/olive-mills/',
  '/greece/santorini/',
  '/greece/santorini/wineries/',
  '/greece/peloponnese/wineries/',
  '/greece/northern-greece/wineries/',
  '/italy/sicily/wineries/',
  '/portugal/alentejo/wineries/',
  '/italy/puglia/olive-mills/',
  '/italy/tuscany/wineries/',
  '/norway/vestland/cideries/',
  '/italy/piedmont/wineries/',
  '/greece/thessaly/wineries/',
];
