...
- [ ] Configure and verify the live webhook endpoint/event subscriptions for Partner Billing. Stripe currently has no webhook endpoint configured, so activation must not proceed until the signing secret is stored safely server-side.
