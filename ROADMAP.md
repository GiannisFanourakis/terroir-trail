...
- [ ] Enable `STRIPE_PARTNER_BILLING_ENABLED=true` in Cloud Run only after live webhook verification, the completed sandbox billing E2E, and an explicit production-launch decision.
