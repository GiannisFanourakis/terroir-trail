...
- [x] ~~Choose the V1 route/travel-time provider behind a provider-neutral server abstraction.~~ Mapbox Matrix API (`mapbox/driving`) selected in `docs/phase15-8b-routing-provider-decision-v1.md`; no traffic or straight-line fallback in V1.
