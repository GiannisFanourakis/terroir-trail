...
export const PHASE10B_PRODUCERS: Producer[] = [
  ...
  },
  {
    ...
    locationNotes: 'Phase 10B exact-location audit: GAIA Winery point in Koutsi, Nemea was independently matched in OpenStreetMap-backed mapping data and corroborated by the current producer-published Koutsi winery address and telephone. Google Place identity verified against the current GAIA Nemea listing; road access remains not publicly confirmed.',
    visitStatus: 'public_visits',
