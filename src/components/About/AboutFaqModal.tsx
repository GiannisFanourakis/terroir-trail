...
export const FAQ_DATA: FaqItem[] = [
  {
    ...
    highlight:
      'Independent producer discovery built around useful, practical travel information.',
  },
  {
    id: 'why-terroirtrail',
    category: 'about',
    ...
    highlight:
      'Bringing scattered rural producer signals into one curated discovery guide.',
  },
  {
    ...
    highlight:
      'Every active category is presented under the same evidence-first research standard.',
  },
  {
    ...
    highlight:
      'Unknown does not mean No: we never convert missing evidence into travel claims.',
  },
  {
  ...
  },
  {
    ...
    highlight:
      'Coverage expands across Europe without weakening our evidence and publication standard.',
  },
  {
  ...
  },
  {
    ...
    highlight:
      'Booking rules and walk-in availability are verified independently.',
  },
  {
    id: 'road-access',
    category: 'visiting',
    ...
    highlight:
      'Location and road access are separate: road guidance fails closed.',
  },
  {
    id: 'direct-contact',
    category: 'visiting',
    ...
    highlight:
      'Use the producer’s official contact details for current visiting arrangements.',
  },
  {
    id: 'tasting-costs',
    category: 'visiting',
  ...
  },
  {
    ...
    categoryLabel: 'For Producers',
    question:
      'I own or represent a listed producer. How can I manage the listing?',
    answer:
  ...
  },
  {
    ...
    highlight:
      'Factual corrections and first-party evidence updates are always welcomed.',
  },
  {
    ...
    categoryLabel: 'For Producers',
    question:
      'Does TerroirTrail sell bookings, paid passes, or charge commissions?',
    answer:
      'TerroirTrail remains discovery-first and does not charge booking commissions. Travelers can optionally buy a €9.99 14-day Holiday Pass or a €24.99/year Annual Explorer Pass for planning conveniences such as ad-free use, printable Trip Packs, calendar export and offline trip snapshots; producer discovery, visitability, road/access facts and direct contact stay free. After a producer claim is approved, the verified Host can separately subscribe to TerroirTrail Partner for €199/year for clearly labelled, Admin-reviewed paid promotion. Public tasting checkout and chauffeur checkout remain inactive, and display advertising remains disabled.',
    highlight:
      'Paid Passes add convenience, not privileged access to producer or safety information.',
  },
];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/85 backdrop-blur-md animate-in fade-in duration-200 select-none">
      <div className="relative w-full max-w-4xl bg-stone-950 text-stone-100 rounded-3xl shadow-2xl border border-white/15 overflow-hidden flex flex-col max-h-[92vh]">
          ...
          {activeTab === 'about' ? (
            <div className="space-y-7 animate-in fade-in duration-200">
              <div className="rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-stone-900 to-stone-950 p-6 sm:p-8 space-y-4">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold font-serif-title text-white tracking-tight leading-snug max-w-3xl">
                  Discover independent makers and the places behind what they
                  make.
                </h1>
                <p className="text-xs sm:text-sm text-stone-300 leading-relaxed max-w-3xl">
                  TerroirTrail is an independent discovery guide connecting
                  culinary travelers, road-trippers, and slow travelers with
                  authentic place-based producers across Europe. It helps you
                  find wineries, breweries, cideries, distilleries, olive and
                  other oil mills, dairies, apiaries, confectionery makers, herb
                  and mushroom farms, and traditional farms — with direct
                  producer contact, clear visiting guidance, and practical
                  road-access notes before you make a rural trip.
                </p>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 pt-5 border-t border-white/10">
                  <Metric
                    value={String(CATALOGUE_SUMMARY.producers)}
                    label="Active listings"
                  />
                  <Metric
                    value={String(CATALOGUE_SUMMARY.countries)}
                    label="Countries"
                  />
                  <Metric
                    value={String(CATALOGUE_SUMMARY.destinations)}
                    label="Destinations"
                  />
                  <Metric
                    value={String(CATALOGUE_SUMMARY.categories)}
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-stone-900 border border-white/10 space-y-2.5">
                ...
                <p className="text-xs sm:text-sm text-stone-300 leading-relaxed">
                  Rural producer discovery is fragmented. Useful travel
                  information is often scattered between individual producer
                  websites, business listings, maps, social media, and outdated
                  tourism pages. TerroirTrail brings those signals into one
                  curated discovery experience — giving travelers practical,
                  source-backed facts without pretending that missing
              ...
              <div className="p-5 sm:p-6 rounded-2xl bg-stone-900 border border-amber-500/30 bg-gradient-to-br from-amber-500/5 via-stone-900 to-stone-950 space-y-4">
                ...
                <p className="text-xs sm:text-sm text-stone-300 leading-relaxed">
                  TerroirTrail never converts an absence of evidence into an
                  assumption or an unsupported travel promise. When visitor or
                  access conditions have not been verified from first-party
                  sources, they stay clearly marked as unconfirmed. TerroirTrail
              ...
              <div className="p-5 rounded-2xl bg-stone-900 border border-white/10 space-y-2">
                ...
                <p className="text-xs text-stone-300 leading-relaxed">
                  The active catalogue currently spans{' '}
                  {CATALOGUE_SUMMARY.countries} countries — {COUNTRY_SCOPE_TEXT}{' '}
                  — across {CATALOGUE_SUMMARY.categories} producer categories:{' '}
                  {CATEGORY_SCOPE_TEXT}. Coverage is driven by published,
                  verified active records rather than a fixed country list,
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30">
                <p className="text-xs text-stone-300 text-center sm:text-left">
                  Have questions about visiting producers, road access, or the
                  traveler passport?
                </p>
              ...
              <div className="p-5 rounded-2xl bg-stone-900 border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
                <div>
                  ...
                  <p className="mt-1 text-[11px] text-stone-400">
                    Email us or find TerroirTrail on Instagram.
                  </p>
                </div>
                <button
                  type="button"
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
              <div className="rounded-3xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 via-stone-900 to-stone-950 p-6 sm:p-8">
                ...
                <h1 className="mt-3 text-2xl sm:text-3xl font-bold font-serif-title text-white">
                  Contact TerroirTrail
                </h1>
                <p className="mt-3 max-w-2xl text-xs sm:text-sm text-stone-300 leading-relaxed">
                  Questions, listing corrections, producer enquiries or
                  collaboration ideas are welcome. For current visit times,
                  prices or same-day arrangements, contact the producer directly
                  through the official details on its listing. A published
                  listing does not by itself imply a commercial partnership with
                  TerroirTrail.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1fr_220px] gap-4">
                <div className="space-y-4">
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="mt-1 text-sm sm:text-base font-bold text-white group-hover:text-amber-300 transition break-all">
                          {CONTACT_EMAIL}
                        </div>
                        <div className="mt-1 text-[11px] text-stone-400">
                          Questions, corrections, producer enquiries and
                          collaborations.
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-sm sm:text-base font-bold text-white group-hover:text-amber-300 transition">
                          @TERROIRTRAIL
                        </div>
                        <div className="mt-1 text-[11px] text-stone-400">
                          Follow the project and message us on Instagram.
                        </div>
                      </div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="mt-1 text-base font-bold text-white group-hover:text-amber-300 transition">
                      Are you a producer who belongs on TerroirTrail?
                    </div>
                    <p className="mt-2 text-[11px] leading-relaxed text-stone-400">
                      Tell us who you are, where you are based and what you
                      make. We review every listing independently.
                    </p>
                    <div className="mt-3 text-xs font-bold text-amber-300">
                      {CONTACT_EMAIL}
                    </div>
                    <div className="mt-1 text-[10px] text-stone-500">
                      An enquiry does not automatically imply inclusion or a
                    ...
                    <div className="p-5 rounded-2xl bg-stone-900 border border-white/10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                      <div>
                        <div className="text-sm font-bold text-white">
                          Are you a listed producer?
                        </div>
                        <p className="mt-1 text-[11px] text-stone-400">
                          Use the Host Portal to claim or manage your producer
                          presence.
                        </p>
                      </div>
                      <button
        ...
        <div className="px-5 sm:px-6 py-2.5 bg-stone-900 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-2 text-[11px] text-stone-500 shrink-0">
          <span>
            Copyright © 2026 TerroirTrail · Independent agritourism discovery
          </span>
          {onOpenLegal && (
...
const Metric: React.FC<{ value: string; label: string }> = ({
  ...
  <div className="p-3 rounded-2xl bg-stone-950/60 border border-white/10 text-center">
    <div className="text-amber-400 text-sm sm:text-base font-mono font-bold break-words">
      {value}
    </div>
    <div className="text-[9px] text-stone-400 uppercase font-semibold tracking-wider mt-1">
      {label}
    </div>
  </div>
);
