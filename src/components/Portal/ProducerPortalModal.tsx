            ...
            <div className="space-y-3 pt-2 max-w-md mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                <button
                  ...
                  className="flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl bg-white text-stone-900 font-bold text-xs hover:bg-stone-100 active:scale-98 transition shadow disabled:opacity-50 cursor-pointer"
                >
                  ...
                  <span>{oauthLoading === 'google' ? 'Connecting...' : 'Sign In with Google'}</span>
                </button>

                <button
                  type="button"
                  onClick={handleGateAppleLogin}
                  disabled={oauthLoading !== null}
                  className="flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl bg-stone-900 border border-white/20 text-white font-bold text-xs hover:bg-stone-850 active:scale-98 transition shadow disabled:opacity-50 cursor-pointer"
                >
                  ...
                  <span>{oauthLoading === 'apple' ? 'Connecting...' : 'Sign In with Apple'}</span>
                </button>
              </div>
