...
const SPONSOR_CAMPAIGNS: SponsorCampaign[] = [
  ...
  {
    id: 'localrent-cars',
    tag: 'Official Partner · Terroir Mobility',
    title: 'Low-Deposit All-Terrain Car Rentals for Island Wine Trails',
    desc: 'Book local family-owned fleets across Crete, Peloponnese & Tuscany. Zero excess, no credit card needed.',
  ...
  {
    id: 'welcome-pickups',
    tag: 'Official Partner · Executive Transfers',
    title: 'Private Vineyard Chauffeurs & Airport VIP Transfers',
    desc: 'English-speaking local drivers, luxury Mercedes vans & sedans with pre-booked fixed rates.',
    ctaText: 'Book Private Driver',
