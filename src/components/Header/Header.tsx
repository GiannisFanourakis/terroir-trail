          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="hidden sm:flex items-center gap-1.5 sm:gap-2 shrink-0">
              ...
              >
                ...
                {savedCount > 0 && (
                  <span className="px-1.5 py-0.2 rounded-full bg-rose-500/20 text-rose-300 text-[10px] font-mono">{savedCount}</span>
                )}
              </button>
              ...
              {onOpenExplorerPass && (
                ...
                >
                  ...
                  {user?.hasExplorerPass ? (
                    ...
                    <span className="text-[11px]">VIP Pass</span>
                  )}
                </button>
              )}
              ...
              {user?.isProducer && user.claimedProducerId ? (
                onOpenProducerPortal && (
                  ...
                  >
                    ...
                    <span className="truncate max-w-[130px]">{user.producerName || 'Estate Host'}</span>
                    <span className="text-[9px] px-1.5 py-0.2 rounded-full bg-amber-400 text-stone-950 font-extrabold uppercase">Host</span>
                  </button>
                )
              ) : (
                <button
            ...
            <div className="flex sm:hidden items-center gap-1.5 shrink-0">
              ...
              >
                <Heart className={`w-3.5 h-3.5 shrink-0 ${favoritesOnly || savedCount > 0 ? 'fill-rose-400 text-rose-400' : 'text-stone-400'}`} />
                {savedCount > 0 && (
                  <span className="text-[10px] font-mono text-rose-300">{savedCount}</span>
                )}
              </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-3 py-3 text-sm font-semibold rounded-xl border transition cursor-pointer ${
                    user?.hasExplorerPass
                      ...
                      : 'bg-stone-900 text-stone-200 border-white/10 hover:border-amber-400/40'
                  }`}
                >
