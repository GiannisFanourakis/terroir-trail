  ...
  const result = await attemptDelivery(
    {
      ...
      text: [
        ...
        'You can save producers, build your Terroir Passport, keep private tasting notes, and explore verified local producers and Discovery Guides.',
        '',
        `Start exploring: ${appUrl}`,
        '',
        'We are building TerroirTrail around direct connections with authentic local makers and trustworthy travel information.',
        '',
        'Welcome aboard,',
        'The TerroirTrail Team',
      ].join('\n'),
      html: `<p>Hi ${safeName},</p><p>Welcome to <strong>TerroirTrail</strong>. Your traveler account is ready.</p><p>You can save producers, build your Terroir Passport, keep private tasting notes, and explore verified local producers and Discovery Guides.</p><p><a href="${escapeHtml(appUrl)}">Start exploring TerroirTrail</a></p><p>We are building TerroirTrail around direct connections with authentic local makers and trustworthy travel information.</p><p>Welcome aboard,<br>The TerroirTrail Team</p>`,
    },
    sender
  );
