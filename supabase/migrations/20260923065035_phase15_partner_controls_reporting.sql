-- Phase 15 Block C: Host/Admin commercial controls, campaign reporting,
-- public-state lifecycle guards and scheduled campaign reconciliation.
-- Applied to production as Supabase migration 20260923065035.
